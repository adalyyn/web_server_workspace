	...
	<form name="memberEnrollFrm" action="" method="POST">
		<table>
			...
			<tr>
				<th>휴대폰<sup>*</sup></th>
				<td>	
					<input type="tel" placeholder="(-없이)01012345678" name="phone" id="phone" maxlength="11" value = "01012341221" required><br>
				</td>
			</tr>
			<tr>
				<th>성별 </th>
...
document.querySelector("#passwordCheck").onblur = (e)=>{
 ...
 /**
 *폼 유효성 검사(DB의 not null에 대해서만 체크)
 */
